...
public class VideoView<P extends AbstractPlayer> extends FrameLayout
    ...
    public VideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mCurrentScreenScaleType = a.getInt(R.styleable.VideoView_screenSType, mCurrentScreenScaleType);
        mPlayerBackgroundColor = a.getColor(R.styleable.VideoView_playerBGColor, Color.BLACK);
        a.recycle();
